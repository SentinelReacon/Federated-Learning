...
# Training the model for OR problem
...
class SocketThread(threading.Thread):
    ...
    def run(self):
        ...
        while True:
            ...
            date_time = "\nWaiting to Receive Data from {client_info} Starting from {day}/{month}/{year} {hour}:{minute}:{second}".format(year=time_struct.tm_year, month=time_struct.tm_mon, day=time_struct.tm_mday, hour=time_struct.tm_hour, minute=time_struct.tm_min, second=time_struct.tm_sec, client_info=self.client_info)
            print(date_time)
...
print("Socket Bound to Address & Port Number.\n")
...
while True:
    try:
        ...
        soc.close()
        print("(Timeout) Socket Closed Because no Connections Received in the given interval of time.\n")
        break